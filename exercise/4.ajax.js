...
xhttp.onerror = () => {
  // error di kitanya, misal : kita mau ngambil data ke internet, misal ke facebook.com -> kita fetching / get data ke mereka, tapi internet kita mati di tengah jalan
